...
public class BaseJedisClusterConfiguration extends PathMatchingResourcePatternResolver{
	public static JedisCluster getJedisCluster(InputStream jedisResInput) throws IOException {
